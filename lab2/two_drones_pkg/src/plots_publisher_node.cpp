...
class PlotsPublisherNode : public rclcpp::Node {
  ...
  class TrajTrail {
    ...
    void update() {
      ...
      geometry_msgs::msg::TransformStamped transform;  // NOTE: you need to populate this transform
      try {
        ...
        // transform.header.stamp = parent->get_clock()->now();
        // transform.header.frame_id = t.frame_id;
        // transform.child_frame_id = t.child_frame_id;
        // transform.transform.translation.x = t.transform.x;
        // transform.transform.translation.y = t.transform.x;
        // transform.transform.translation.z = t.transform.x;
        // transform.transform.rotation.x = t.transform.rotation.x;
        // transform.transform.rotation.y = t.transform.rotation.y;
        // transform.transform.rotation.z = t.transform.rotation.z;
        // transform.transform.rotation.w = t.transform.rotation.w;
